    ...
    <section id="contact" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-50/30 p-10 md:p-16 rounded-[3rem] border border-rose-200 shadow-[0_0_80px_rgba(255,105,180,0.25)]">
            <h3 className="font-serif text-2xl text-center text-slate-900 mb-12 italic">
              Envoyez-nous un message discret
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="space-y-3">
                  <Label className="text-[10px] uppercase tracking-[0.2em] text-slate-400 ml-1">
                    Nom complet
                  </Label>
                  <Input
                    name="name"
              ...
              <div className="flex justify-center pt-4">
                <Button
                  type="submit"
                  variant="romantic"
                  className="w-full md:w-[320px] h-16 rounded-full text-lg font-bold shadow-2xl shadow-primary/30 hover:scale-[1.05] transition-all duration-300"
                >
